# -*- coding: utf-8 -*-
#
# astroalign documentation build configuration file, created by
# sphinx-quickstart on Mon Jan 18 14:29:21 2016.
#
...
htmlhelp_basename = 'astroaligndoc'
...
latex_documents = [
    (master_doc, 'astroalign.tex', u'astroalign Documentation',
     u'Martin Beroiz', 'manual'),
]
...
man_pages = [
    (master_doc, 'astroalign', u'astroalign Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'astroalign', u'astroalign Documentation',
     author, 'astroalign', 'One line description of project.',
     'Miscellaneous'),
]
